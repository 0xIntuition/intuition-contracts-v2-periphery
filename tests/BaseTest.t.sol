...
import { IMultiVault, ApprovalTypes } from "intuition-contracts-v2/interfaces/IMultiVault.sol";
import { MetaERC20DispatchInit, FinalityState } from "intuition-contracts-v2/interfaces/IMetaLayer.sol";
import { CoreEmissionsControllerInit } from "intuition-contracts-v2/interfaces/ICoreEmissionsController.sol";
import {
    GeneralConfig,
    AtomConfig,
    TripleConfig,
    ...
    VaultFees,
    BondingCurveConfig
} from "intuition-contracts-v2/interfaces/IMultiVaultCore.sol";
...
import { LinearCurve } from "intuition-contracts-v2/protocol/curves/LinearCurve.sol";
import { OffsetProgressiveCurve } from "intuition-contracts-v2/protocol/curves/OffsetProgressiveCurve.sol";
import { ProgressiveCurve } from "intuition-contracts-v2/protocol/curves/ProgressiveCurve.sol";
